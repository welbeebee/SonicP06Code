...
public static class Game
{
	...
	public static string E3LoadMode = "E3LoadMode";
	...
	public static string TGS_KDV_SN_Scene = "kdv_tgsa_sn";

	public static string TGS_KDV_SD_Scene = "kdv_tgsb_sd";

	public static string TGS_KDV_SV_Scene = "kdv_tgsd_sv";

	public static string E3_CSC_Scene = "csc_e3f_sv";
	...
	public static void ChangeArea(string Area, string Mode = "")
	{
		...
		Singleton<GameManager>.Instance.SetLoadingTo(Area, (Mode == "") ? MenuLoadMode : Mode);
	}
	...
	public static void SignalPlayer(string Object)
	{
		if ((bool)GameObject.FindGameObjectWithTag("Player"))
		{
			GameObject.FindGameObjectWithTag("Player").SendMessage(Object, SendMessageOptions.DontRequireReceiver);
		}
	}
