...
public class Settings : Singleton<Settings>
{
	...
	public class GameSettings
	{
		...
		public int InvertCamX;

		public int InvertCamY;
	...
	private void Awake()
	{
		...
		if (settings.Resolution == -1 || settings.Resolution > AvailableResolutions.Length - 1)
		{
