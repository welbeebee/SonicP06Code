...
public class SplashScreens : MonoBehaviour
{
	...
	private void Start()
	{
		if (GameInitializer)
		{
			...
			Singleton<Settings>.Instance.StartSettings();
			...
			DebugCode = new string[8] { "Button X", "Button B", "Button A", "Button Y", "Left Bumper", "Right Bumper", "Left Trigger", "Right Trigger" };
			CodeIndex = 0;
		}
