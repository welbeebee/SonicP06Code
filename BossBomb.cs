...
public class BossBomb : MonoBehaviour
{
	...
	{
		if (collider.gameObject.layer != LayerMask.NameToLayer("Default") && collider.gameObject.layer != LayerMask.NameToLayer("DefaultObject") && !Destroyed)
		{
	...
	{
		if (collision.collider.gameObject.layer != LayerMask.NameToLayer("Default") && collision.collider.gameObject.layer != LayerMask.NameToLayer("DefaultObject") && !Destroyed)
		{
