	...
	private void SetFunction(string Stage, string CharSection, string Function, GameObject Transmitter = null)
	{
		if (Stage == "test")
		{
			...
			if (CharSection == "b_sn")
			{
				...
				{
					SceneManager.LoadScene("TGSMenu", LoadSceneMode.Single);
				}
				if (Function == "goto_csc")
				{
					Game.ChangeArea(Game.E3_CSC_Scene, Game.E3LoadMode);
			...
			if (CharSection == "d_sn" && Function == "goto_b")
			{
				Game.ChangeArea("test_b_sn");
			}
		}
		...
		if (Stage == "dtd")
		{
			...
			if (CharSection == "b_sv")
			{
				...
				if (Function == "door10")
				{
					...
					Game.ProcessMessage("common_laser2000", "GateOpen");
					Game.ProcessMessage("common_laser2001", "GateOpen");
					Game.ProcessMessage("common_laser2002", "GateOpen");
					Game.ProcessMessage("common_laser2003", "GateOpen");
					Game.StartEntityByName("AmyCameraDestroy");
				}
				if (Function == "door12")
				{
					Game.Signal("dtd_door03");
				...
				if (Function == "lotusup_ladder02")
				{
					...
					Game.ProcessMessage("physicspath1010", "PsiEffect", true);
					Game.Signal("physicspath1011");
					Game.ProcessMessage("physicspath1011", "PsiEffect", true);
					Game.Signal("physicspath1012");
					Game.ProcessMessage("physicspath1012", "PsiEffect", true);
					Game.Signal("physicspath1013");
					Game.ProcessMessage("physicspath1013", "PsiEffect", true);
					Game.Signal("physicspath1014");
					Game.ProcessMessage("physicspath1014", "PsiEffect", true);
					Game.Signal("physicspath1015");
					Game.ProcessMessage("physicspath1015", "PsiEffect", true);
				}
		...
		if (Stage == "wap")
		{
			...
			if (CharSection == "b_sv")
			{
				...
				if (Function == "esp01")
				{
					...
					Game.Signal("physicspath03_1000");
					Game.ProcessMessage("physicspath03_1000", "PsiEffect", true);
				}
				if (Function == "cage01")
				{
					Game.Signal("common_cage01");
		...
		if (Stage == "csc")
		{
			...
			if (CharSection == "b_sn")
			{
				...
				{
					Game.Signal("bldgexplode01");
					Game.Signal("Physicsglass1012");
					Game.Signal("Physicsglass1013");
					Game.Signal("Physicsglass1014");
					Game.Signal("Physicsglass1015");
					Game.Signal("Physicsglass1016");
					Game.Signal("Physicsglass1017");
					Game.Signal("Physicsglass1018");
					Game.Signal("Physicsglass1019");
					Game.Signal("Physicsglass1020");
					Game.Signal("Physicsglass1021");
					Game.Signal("Physicsglass1022");
					Game.Signal("Physicsglass1023");
					Game.Signal("Physicsglass1024");
					Game.Signal("Physicsglass1025");
					Game.Signal("Physicsglass1026");
					Game.Signal("Physicsglass1027");
					Game.Signal("impulsesphere01_rec");
					Game.Signal("impulsesphere02_rec");
					Game.Signal("impulsesphere03_rec");
					Game.Signal("impulsesphere04_rec");
					Game.Signal("impulsesphere05_rec");
					Game.Signal("impulsesphere06_rec");
					Game.Signal("impulsesphere07_rec");
					Game.Signal("impulsesphere08_rec");
					Game.Signal("bldgexplode02_rec");
					Game.Signal("Physicsglass1060");
					Game.Signal("Physicsglass1061");
					Game.Signal("Physicsglass1062");
					Game.Signal("Physicsglass1063");
					Game.Signal("Physicsglass1064");
					Game.Signal("Physicsglass1065");
					Game.Signal("Physicsglass1066");
					Game.Signal("Physicsglass1067");
					Game.Signal("Physicsglass1068");
					Game.Signal("Physicsglass1069");
					Game.Signal("Physicsglass1070");
					Game.Signal("Physicsglass1071");
					Game.Signal("Physicsglass1072");
					Game.Signal("Physicsglass1073");
					Game.Signal("Physicsglass1074");
					Game.Signal("Physicsglass1075");
					Game.Signal("impulsesphere41_rec");
					Game.Signal("impulsesphere102_rec");
					Game.Signal("impulsesphere103_rec");
					Game.Signal("impulsesphere104_rec");
					Game.Signal("impulsesphere105_rec");
					Game.Signal("impulsesphere106_rec");
					Game.Signal("impulsesphere107_rec");
					Game.Signal("impulsesphere108_rec");
				}
				if (Function == "explosion_002")
				{
					Game.Signal("Physicsglass1004");
					Game.Signal("Physicsglass1005");
					Game.Signal("Physicsglass1006");
					Game.Signal("Physicsglass1007");
					Game.Signal("Physicsglass1008");
					Game.Signal("Physicsglass1009");
					Game.Signal("Physicsglass1010");
					Game.Signal("Physicsglass1011");
					Game.Signal("Physicsglass1028");
					Game.Signal("Physicsglass1029");
					Game.Signal("Physicsglass1030");
					Game.Signal("Physicsglass1031");
					Game.Signal("Physicsglass1032");
					Game.Signal("Physicsglass1033");
					Game.Signal("Physicsglass1034");
					Game.Signal("Physicsglass1035");
					Game.Signal("impulsesphere09_rec");
					Game.Signal("impulsesphere10_rec");
					Game.Signal("impulsesphere11_rec");
					Game.Signal("impulsesphere12_rec");
					Game.Signal("impulsesphere13_rec");
					Game.Signal("impulsesphere14_rec");
					Game.Signal("impulsesphere15_rec");
					Game.Signal("impulsesphere16_rec");
					Game.Signal("impulsesphere17_rec");
					Game.Signal("impulsesphere18_rec");
					Game.Signal("impulsesphere19_rec");
					Game.Signal("impulsesphere20_rec");
					Game.Signal("impulsesphere21_rec");
					Game.Signal("impulsesphere22_rec");
					Game.Signal("impulsesphere23_rec");
					Game.Signal("impulsesphere24_rec");
					Game.Signal("Physicsglass1052");
					Game.Signal("Physicsglass1053");
					Game.Signal("Physicsglass1054");
					Game.Signal("Physicsglass1055");
					Game.Signal("Physicsglass1056");
					Game.Signal("Physicsglass1057");
					Game.Signal("Physicsglass1058");
					Game.Signal("Physicsglass1059");
					Game.Signal("Physicsglass1076");
					Game.Signal("Physicsglass1077");
					Game.Signal("Physicsglass1078");
					Game.Signal("Physicsglass1079");
					Game.Signal("Physicsglass1080");
					Game.Signal("Physicsglass1081");
					Game.Signal("Physicsglass1082");
					Game.Signal("Physicsglass1083");
					Game.Signal("impulsesphere109_rec");
					Game.Signal("impulsesphere110_rec");
					Game.Signal("impulsesphere111_rec");
					Game.Signal("impulsesphere112_rec");
					Game.Signal("impulsesphere113_rec");
					Game.Signal("impulsesphere114_rec");
					Game.Signal("impulsesphere115_rec");
					Game.Signal("impulsesphere116_rec");
					Game.Signal("impulsesphere117_rec");
					Game.Signal("impulsesphere118_rec");
					Game.Signal("impulsesphere119_rec");
					Game.Signal("impulsesphere120_rec");
					Game.Signal("impulsesphere121_rec");
					Game.Signal("impulsesphere122_rec");
					Game.Signal("impulsesphere123_rec");
					Game.Signal("impulsesphere124_rec");
				}
				if (Function == "explosion_003")
				{
					Game.Signal("Physicsglass1000");
					Game.Signal("Physicsglass1001");
					Game.Signal("Physicsglass1002");
					Game.Signal("Physicsglass1003");
					Game.Signal("Physicsglass1036");
					Game.Signal("Physicsglass1037");
					Game.Signal("Physicsglass1038");
					Game.Signal("Physicsglass1039");
					Game.Signal("impulsesphere25_rec");
					Game.Signal("impulsesphere26_rec");
					Game.Signal("impulsesphere27_rec");
					Game.Signal("impulsesphere28_rec");
					Game.Signal("impulsesphere29_rec");
					Game.Signal("impulsesphere30_rec");
					Game.Signal("impulsesphere31_rec");
					Game.Signal("impulsesphere32_rec");
					Game.Signal("Physicsglass1048");
					Game.Signal("Physicsglass1049");
					Game.Signal("Physicsglass1050");
					Game.Signal("Physicsglass1051");
					Game.Signal("Physicsglass1084");
					Game.Signal("Physicsglass1085");
					Game.Signal("Physicsglass1086");
					Game.Signal("Physicsglass1087");
					Game.Signal("impulsesphere125_rec");
					Game.Signal("impulsesphere126_rec");
					Game.Signal("impulsesphere127_rec");
					Game.Signal("impulsesphere128_rec");
					Game.Signal("impulsesphere129_rec");
					Game.Signal("impulsesphere130_rec");
					Game.Signal("impulsesphere131_rec");
					Game.Signal("impulsesphere132_rec");
				}
				if (Function == "explosion_004")
				{
					Game.Signal("Physicsglass1040");
					Game.Signal("Physicsglass1041");
					Game.Signal("Physicsglass1042");
					Game.Signal("Physicsglass1043");
					Game.Signal("impulsesphere33_rec");
					Game.Signal("impulsesphere34_rec");
					Game.Signal("impulsesphere35_rec");
					Game.Signal("impulsesphere36_rec");
					Game.Signal("Physicsglass1088");
					Game.Signal("Physicsglass1089");
					Game.Signal("Physicsglass1090");
					Game.Signal("Physicsglass1091");
					Game.Signal("impulsesphere133_rec");
					Game.Signal("impulsesphere134_rec");
					Game.Signal("impulsesphere135_rec");
					Game.Signal("impulsesphere136_rec");
				}
				if (Function == "explosion_005")
				{
					Game.Signal("Physicsglass1044");
					Game.Signal("Physicsglass1045");
					Game.Signal("Physicsglass1046");
					Game.Signal("Physicsglass1047");
					Game.Signal("impulsesphere37_rec");
					Game.Signal("impulsesphere38_rec");
					Game.Signal("impulsesphere39_rec");
					Game.Signal("impulsesphere40_rec");
					Game.Signal("Physicsglass1092");
					Game.Signal("Physicsglass1093");
					Game.Signal("Physicsglass1094");
					Game.Signal("Physicsglass1095");
					Game.Signal("impulsesphere137_rec");
					Game.Signal("impulsesphere138_rec");
					Game.Signal("impulsesphere139_rec");
					Game.Signal("impulsesphere140_rec");
				}
				if (Function == "BtoC")
				{
		...
		if (Stage == "flc")
		{
			if (CharSection == "a_sn")
			{
				...
				if (Function == "lookatvolcano")
				{
					Game.SignalPlayer("LookAtVolcano");
				}
			}
			if (CharSection == "a_sd")
			{
			...
			if (CharSection == "b_sn")
			{
				...
				if (Function == "door_open02")
				{
					...
					Game.ProcessMessage("changelight03", "OFF");
					Game.ProcessMessage("changelight04", "OFF");
					Game.ProcessMessage("changelight05", "OFF");
					Game.ProcessMessage("flc_door04", "GateOpen");
				...
				if (Function == "amigo_doors")
				{
					Game.ProcessMessage("flc_door1000", "GateClose");
					Game.ProcessMessage("flc_door1001", "GateClose");
				}
			}
			if (CharSection == "b_sd")
			{
		...
		if (Stage == "rct")
		{
			if (CharSection == "a_sn")
			{
				...
				{
					Game.Signal("rct_container_bomb1000");
				...
				{
					Game.Signal("rct_container_bomb1001");
				...
				{
					Game.Signal("rct_container_bomb1002");
		...
		if (Stage == "kdv")
		{
			...
			if (CharSection == "d_sd")
			{
				...
				if (Function == "cantbelieveit_room")
				{
					Game.StartEntityByName("GroupHelper1000");
				}
				if (Function == "cantbelieveit_cage")
				{
					Game.Signal("common_cage1000");
				}
				if (Function == "cantbelieveit_clear")
				{
					Game.Signal("kdv_door1000");
					Game.StartEntityByName("GroupHelper1001");
				}
			}
			if (CharSection == "d_sv")
		...
		if (CharSection == "b_sn")
		{
			...
			if (Function == "door_close02")
			{
				Game.ProcessMessage("aqa_door01", "GateClose");
			}
			if (Function == "door03")
			{
				Game.Signal("aqa_door03");
