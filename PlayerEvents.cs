...
public class PlayerEvents : MonoBehaviour
{
	...
	public void SetGrindTrickFX(int Result)
	{
		if ((bool)PM.FXBase.RailParticles)
		{
			PM.FXBase.RailParticles.StopFX = Result == 1;
			if (Result == 0)
			{
				PM.FXBase.CreateRailContactFX(PM.Base.RailType);
			}
		}
	}
}
