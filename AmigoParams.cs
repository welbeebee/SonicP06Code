...
public class AmigoParams : MonoBehaviour
{
	...
	{
		PlayRandomVoice(Group, RandomPlayChance: true);
	}

	public void PlayTarotFX()
	{
		AB.PlayAmyTarotFX(Enable: true);
	}
