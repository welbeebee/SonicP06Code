...
public class MainMenu : MonoBehaviour
{
	...
	public Image[] UICheckPointElements;
	...
	private string[][] GameRoomOptions_Switch = new string[13][]
	{
		...
		new string[2] { "msg_off", "msg_on" },
		new string[2] { "msg_off", "msg_on" },
		new string[4] { "msg_default", "msg_adventure", "msg_adventure2", "msg_retail" },
	...
	private int[] GameRoomSettings = new int[13];

	private string[][] Resolution_Switch;

	private string[][] GraphicsOptions_Switch = new string[20][]
	{
		...
		new string[2] { "msg_off", "msg_on" },
		new string[3] { "msg_off", "msg_rainsplashes", "msg_on" },
		new string[2] { "msg_off", "msg_on" },
		new string[3] { "msg_off", "msg_medium", "msg_high" },
		new string[3] { "msg_off", "msg_refonperf", "msg_refonstand" },
	...
	private int[] GraphicsSettings = new int[20];
	...
	private string[][] UIOptions_Switch = new string[8][]
	{
		new string[2] { "msg_retail", "msg_e3" },
		new string[4] { "msg_retail", "msg_e3", "msg_cutscene", "msg_off" },
		new string[2] { "msg_retail", "msg_e3" },
		new string[2] { "msg_retail", "msg_e3" },
		new string[2] { "msg_retail", "msg_e3" },
		new string[2] { "msg_retail", "msg_e3" },
	...
	private int[] UISettings = new int[8];
	...
	private void StateExtrasGame()
	{
		...
		if (!UsingXAxis && XAxis != 0f && Index < GameRoomSettings.Length && Index < 10)
		{
			UsingXAxis = true;
			...
			if (Index == 1 && (GameRoomSettings[Index] == 0 || GameRoomSettings[Index] == 1))
			{
				GameRoomSettings[2] = GameRoomSettings[Index];
			}
		}
		UpdateSwitcher(GameRoomSwitchTransforms, GameRoomOptions_Switch, GameRoomSettings);
		if (Index > 9)
		...
		else if (Index == 2)
		{
			if (GameRoomSettings[Index] == 0)
			{
				CommonText.text = "Retail: default FoV of the retail game";
			}
			else
			{
				CommonText.text = "E3: higher FoV used in the E3 and pre-release versions";
			}
		}
		else if (Index == 3)
		{
		...
		if (Singleton<RInput>.Instance.P.GetButtonDown("Button A") || Singleton<RInput>.Instance.P.GetButtonDown("Button X"))
		{
			if ((Index == 10 || Index == 11) && OptionHasChanged)
			{
				SetGameRoomSettings();
	...
	private void StateVideoTab()
	{
		...
		else if (Index == 12)
		{
			if (GraphicsSettings[Index] == 0)
			{
				CommonText.text = "Turns rain effects off";
			}
			else if (GraphicsSettings[Index] == 1)
			{
				CommonText.text = "Displays rain drop splashes hitting surfaces only";
			}
			else
			{
				CommonText.text = "Displays rain weather effects in certain scenarios";
			}
		}
		else if (Index == 13)
		{
	...
	private void StateGameTab()
	{
		...
		{
			CommonText.text = "Camera volumes in stages (only important volumes if turned off)";
		}
		else if (Index == 6)
		{
	...
	private void StateUIConfig()
	{
		...
		{
			CommonText.text = "Select the checkpoint time type";
		}
		else if (Index == 5)
		{
	...
	private void GrabSettings()
	{
		...
		if (Singleton<Settings>.Instance.settings.Resolution == -1 || Singleton<Settings>.Instance.settings.Resolution > Singleton<Settings>.Instance.AvailableResolutions.Length - 1)
		{
		...
		GraphicsSettings[12] = Singleton<Settings>.Instance.settings.RainEffects;
		GraphicsSettings[13] = Singleton<Settings>.Instance.settings.Outlines;
		GraphicsSettings[14] = Singleton<Settings>.Instance.settings.VolumetricLights;
		GraphicsSettings[15] = Singleton<Settings>.Instance.settings.Reflections;
		GraphicsSettings[16] = Singleton<Settings>.Instance.settings.ShadowQuality;
		GraphicsSettings[17] = Singleton<Settings>.Instance.settings.ShadowType;
		GraphicsSettings[18] = Singleton<Settings>.Instance.settings.ShadowDistance;
		GraphicsSettings[19] = Singleton<Settings>.Instance.settings.ShadowCascades;
		...
		GameSettings[5] = Singleton<Settings>.Instance.settings.CameraVolumes;
		...
		UISettings[4] = Singleton<Settings>.Instance.settings.CheckpointType;
		UISettings[5] = Singleton<Settings>.Instance.settings.EnemyHealthType;
		UISettings[6] = Singleton<Settings>.Instance.settings.LoadingScreenType;
		UISettings[7] = Singleton<Settings>.Instance.settings.UIPreset;
		...
		GameRoomSettings[2] = Singleton<Settings>.Instance.settings.FieldOfView;
		GameRoomSettings[3] = Singleton<Settings>.Instance.settings.HomingReticle;
		GameRoomSettings[4] = Singleton<Settings>.Instance.settings.AttackReticles;
		GameRoomSettings[5] = Singleton<Settings>.Instance.settings.SpinEffect;
		GameRoomSettings[6] = Singleton<Settings>.Instance.settings.JumpdashType;
		GameRoomSettings[7] = Singleton<Settings>.Instance.settings.GemShoesType;
		GameRoomSettings[8] = Singleton<Settings>.Instance.settings.UpgradeModels;
		GameRoomSettings[9] = Singleton<Settings>.Instance.settings.E3XBLAMusic;
	}
	...
	private void SetGameRoomSettings()
	{
		...
		Singleton<Settings>.Instance.settings.FieldOfView = GameRoomSettings[2];
		Singleton<Settings>.Instance.settings.HomingReticle = GameRoomSettings[3];
		Singleton<Settings>.Instance.settings.AttackReticles = GameRoomSettings[4];
		Singleton<Settings>.Instance.settings.SpinEffect = GameRoomSettings[5];
		Singleton<Settings>.Instance.settings.JumpdashType = GameRoomSettings[6];
		Singleton<Settings>.Instance.settings.GemShoesType = GameRoomSettings[7];
		Singleton<Settings>.Instance.settings.UpgradeModels = GameRoomSettings[8];
		Singleton<Settings>.Instance.settings.E3XBLAMusic = GameRoomSettings[9];
	}

	private void SetVideoSettings()
	{
		Singleton<Settings>.Instance.settings.DisplayMode = GraphicsSettings[0];
		if (Singleton<Settings>.Instance.settings.Resolution > Singleton<Settings>.Instance.AvailableResolutions.Length - 1)
		{
			Singleton<Settings>.Instance.settings.Resolution = Singleton<Settings>.Instance.AvailableResolutions.Length - 1;
		}
		...
		Singleton<Settings>.Instance.settings.RainEffects = GraphicsSettings[12];
		Singleton<Settings>.Instance.settings.Outlines = GraphicsSettings[13];
		Singleton<Settings>.Instance.settings.VolumetricLights = GraphicsSettings[14];
		Singleton<Settings>.Instance.settings.Reflections = GraphicsSettings[15];
		Singleton<Settings>.Instance.settings.ShadowQuality = GraphicsSettings[16];
		Singleton<Settings>.Instance.settings.ShadowType = GraphicsSettings[17];
		Singleton<Settings>.Instance.settings.ShadowDistance = GraphicsSettings[18];
		Singleton<Settings>.Instance.settings.ShadowCascades = GraphicsSettings[19];
	}
	...
	private void SetGameSettings()
	{
		...
		Singleton<Settings>.Instance.settings.CameraVolumes = GameSettings[5];
	...
	private void SetUISettings()
	{
		...
		Singleton<Settings>.Instance.settings.CheckpointType = UISettings[4];
		Singleton<Settings>.Instance.settings.EnemyHealthType = UISettings[5];
		Singleton<Settings>.Instance.settings.LoadingScreenType = UISettings[6];
		Singleton<Settings>.Instance.settings.UIPreset = UISettings[7];
	}
	...
	private void UpdateUI()
	{
		...
		{
			OptionsArrowTransform.anchoredPosition = new Vector3((Index != 2) ? 60f : 100f, GameRoomSwitchTransforms[Index].anchoredPosition.y - 2f);
		}
		...
		{
			UIDoubleArrowTransform.anchoredPosition = new Vector3((Index != 7) ? (-279f) : (-368f), UIDescriptionTransforms[Index].anchoredPosition.y - 3f);
			UIDoubleArrowSeparator.sizeDelta = new Vector2((Index == 7) ? 155f : ((Index == 1 && UISettings[1] == 2) ? 135f : 100f), UIDoubleArrowSeparator.sizeDelta.y);
			if (Index == 7 && (UISettings[Index] == 0 || UISettings[Index] == 1))
			{
				...
				UISettings[6] = ((UISettings[Index] != 0) ? 1 : 0);
			}
			if (Index != 7 && ((UISettings[7] == 0 && (UISettings[0] != 0 || UISettings[1] != 0 || UISettings[2] != 0 || UISettings[3] != 0 || UISettings[4] != 0 || UISettings[5] != 0 || UISettings[6] != 0)) || (UISettings[7] == 1 && (UISettings[0] != 1 || UISettings[1] != 1 || UISettings[2] != 1 || UISettings[3] != 1 || UISettings[4] != 1 || UISettings[5] != 1 || UISettings[6] != 1))))
			{
				UISettings[7] = 2;
			}
			UIBG.enabled = Index != 5;
			UIDisplayElements[0].enabled = UISettings[0] == 0 && Index != 5 && Index != 6;
			UIDisplayElements[1].enabled = UISettings[0] == 1 && Index != 5 && Index != 6;
			UITextBoxElements[0].enabled = UISettings[1] == 0 && Index != 5 && Index != 6;
			UITextBoxElements[1].enabled = UISettings[1] == 1 && Index != 5 && Index != 6;
			UITextBoxElements[2].enabled = UISettings[1] == 2 && Index != 5 && Index != 6;
			UIItemBoxElements[0].enabled = UISettings[2] == 0 && UISettings[0] == 0 && Index != 5 && Index != 6;
			UIItemBoxElements[1].enabled = UISettings[2] == 0 && UISettings[0] == 1 && Index != 5 && Index != 6;
			UIPauseMenuElements[0].enabled = UISettings[3] == 0 && Index != 5 && Index != 6;
			UIPauseMenuElements[1].enabled = UISettings[3] == 1 && Index != 5 && Index != 6;
			UICheckPointElements[0].enabled = UISettings[4] == 0 && Index == 4;
			UICheckPointElements[1].enabled = UISettings[4] == 1 && Index == 4;
			UIEnemyHealthElements[0].enabled = UISettings[5] == 0 && Index == 5;
			UIEnemyHealthElements[1].enabled = UISettings[5] == 1 && Index == 5;
			UILoadingBGs[0].enabled = UISettings[6] == 0 && Index == 6;
			UILoadingBGs[1].enabled = UISettings[6] == 1 && Index == 6;
		}
