...
public class FlameCore : EventStation
{
	...
	internal LayerMask AttackBlock => LayerMask.GetMask("Default", "DefaultObject", "PlayerCollision", "PlayerCollisionObject", "BreakableObj");
