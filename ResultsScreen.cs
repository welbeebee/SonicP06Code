...
public class ResultsScreen : UIBase
{
	...
	private void Start()
	{
		...
		string text = "";
		if (CurrentStage == Game.TGS_KDV_SN_Scene || CurrentStage == Game.TGS_KDV_SD_Scene || CurrentStage == Game.TGS_KDV_SV_Scene || CurrentStage == Game.E3_CSC_Scene)
		{
			text = "stg_extra";
		}
		else
		...
		if (!CurrentStage.Contains("test") && CurrentStage != Game.TGS_KDV_SN_Scene && CurrentStage != Game.TGS_KDV_SD_Scene && CurrentStage != Game.TGS_KDV_SV_Scene && CurrentStage != Game.E3_CSC_Scene)
		{
	...
	{
		if (!CurrentStage.Contains("test") && CurrentStage != Game.TGS_KDV_SN_Scene && CurrentStage != Game.TGS_KDV_SD_Scene && CurrentStage != Game.TGS_KDV_SV_Scene && CurrentStage != Game.E3_CSC_Scene && !FirstStageSave && Time.time - StartTime > 7.15f && !DefineBasicRecords)
		{
			bool flag = false;
	...
	private void StateC()
	{
		...
		if (!CurrentStage.Contains("test") && CurrentStage != Game.TGS_KDV_SN_Scene && CurrentStage != Game.TGS_KDV_SD_Scene && CurrentStage != Game.TGS_KDV_SV_Scene && CurrentStage != Game.E3_CSC_Scene && !FirstStageSave && !DefineTotalScoreRecord)
		{
	...
	private void StateQuitStart()
	{
		...
		NewFinalRank = 5;
		if (!CurrentStage.Contains("test") && CurrentStage != Game.TGS_KDV_SN_Scene && CurrentStage != Game.TGS_KDV_SD_Scene && CurrentStage != Game.TGS_KDV_SV_Scene && CurrentStage != Game.E3_CSC_Scene && !FirstStageSave && FinalRank < StageRecords.BestRank)
		{
	...
	private void StateQuit()
	{
		...
		bool flag3 = CurrentStage.Contains("test") || CurrentStage == Game.TGS_KDV_SN_Scene || CurrentStage == Game.TGS_KDV_SD_Scene || CurrentStage == Game.TGS_KDV_SV_Scene || CurrentStage == Game.E3_CSC_Scene;
		Singleton<GameManager>.Instance.GoToActSelect = !flag3;
		if (GoTo == Game.GoldMedalScene || GoTo == Game.CreditsScene || flag3)
		{
