...
public class Common_Guillotine : MonoBehaviour
{
	...
	private void OnDrawGizmosSelected()
	{
		...
		if (Length > 0)
		{
			...
			{
			case 1:
				Gizmos.DrawWireCube(Vector3.zero, new Vector3(5.95f, 0.75f, 0.75f));
				break;
			case 2:
				Gizmos.DrawWireCube(Vector3.zero, new Vector3(8.09f, 0.75f, 0.75f));
				break;
			case 3:
				Gizmos.DrawWireCube(Vector3.zero, new Vector3(10.29f, 0.75f, 0.75f));
				break;
			}
		}
	}
