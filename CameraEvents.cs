...
public class CameraEvents : ObjectBase
{
	...
	private void OnTriggerEnter(Collider collider)
	{
		...
		if ((bool)player && (Singleton<Settings>.Instance.settings.CameraVolumes != 0 || ImportantVolume))
		{
			IsActive = true;
			PlayerDummy = player;
	...
	{
		if ((bool)PlayerDummy && (Singleton<Settings>.Instance.settings.CameraVolumes != 0 || ImportantVolume))
		{
	...
	private void OnDrawGizmosSelected()
	{
		if (cameraParameters != null)
		{
			...
			if (cameraParameters.Mode == 4 || cameraParameters.Mode == 41 || cameraParameters.Mode == 42 || cameraParameters.Mode == 5 || cameraParameters.Mode == 50)
			{
				Gizmos.color = Color.white;
			...
			if (cameraParameters.Mode == 3 || cameraParameters.Mode == 30 || cameraParameters.Mode == 31 || cameraParameters.Mode == 32)
			{
				Gizmos.color = Color.white;
			...
			if (cameraParameters.Mode == 4 || cameraParameters.Mode == 41 || cameraParameters.Mode == 42)
			{
				Gizmos.color = Color.green;
				Gizmos.DrawWireSphere(cameraParameters.Position, 0.5f);
			}
