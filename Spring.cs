...
public class Spring : ObjectBase
{
	...
	private void OnTriggerEnter(Collider collider)
	{
		...
		if ((bool)component && component.GetAmigoState() != "Vehicle" && !component.IsDead)
		{
			...
			component.OnSpring(base.transform.GetChild(0).position - base.transform.GetChild(0).up * 0.25f, Direction(base.transform.GetChild(0)) * Speed, Timer, AnimMode(), UseTimerToExit, UseTimerToRelease, AlwaysLocked, LandingStop);
		}
	}
