...
public class VehicleBase : ObjectBase
{
	...
	internal LayerMask Collision_Mask => LayerMask.GetMask("Ignore Raycast", "Water", "UI", "PlayerCollision", "PlayerCollisionObject", "BreakableObj", "Object/PlayerOnlyCol");
	...
	{
		_Rigidbody.velocity = Vector3.up * 15f - base.transform.forward.MakePlanar() * 10f;
	}

	public virtual void OnDamage(float Damage, bool KnockBack = false)
	{
		OnVehicleHit(Damage);
		if (KnockBack)
		{
