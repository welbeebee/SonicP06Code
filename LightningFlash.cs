...
public class LightningFlash : MonoBehaviour
{
	...
	private void Start()
	{
		...
		SkyMaterial.SetColor("_TintColor", NormalColor);
	...
	private void Update()
	{
		...
		SkyMaterial.SetColor("_TintColor", Color.Lerp(NormalColor, FlashColor, SkyFlashPatterns[RandomFlashIndex].Evaluate(PatternTime)));
