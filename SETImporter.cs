...
public static class SETImporter
{
	...
	public static GameObject CreateObject(this XmlNode Object, string Class, XmlNodeList ObjectList)
	{
		...
		if (Class == "enemyextra")
		{
			...
			bool restart = childNodes[6].Attributes["param"].Value == "1";
			...
			gameObject.GetComponent<EnemyBase>().SetParameters(restart, findPlayer, isFixed, value43, appearVelocity, value44, homingTarget);
		}
		if (Class == "vehicle")
		{
		...
		if (Class == "tarzan")
		{
			...
			gameObject.GetComponent<Tarzan>().SetParameters(top, bottom, jumpSpeed, hittutaSpeed, hitAngle, jumpCheckAngle, targetObj2);
		}
		if (Class == "espswing")
		{
		...
		if (Class == "eagle")
		{
			...
			gameObject.GetComponent<Eagle>().SetParameters(speed18, value103);
		}
		if (Class == "rope")
		{
